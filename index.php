...
if(x==3){
			...
			$.get("kartyp1.php", { karty : kartyp1 },  function(data) {
...
if(x==1){
			...
			if(x==2){
					 	...
					 	request2.open('GET', 'kartyp2b.txt', false);  // `false` => synchronous request
request2.send(null);
	...
	kartyp2=resultData.split(",");
        ...
        error : function(xhr, textStatus, errorThrown) {
         ...
         timeout: 0,
					...
					$.get("kartyp2b.txt", {  },  function(data) {
						kartyp2=data.split(",");
...
if(parseInt($("#bank1").html())==0){

alert("you lose");

}

if(parseInt($("#bank1").html())==200){
...
//alert(nazwap1+" vs "+nazwap2+" lose");

//$("#wyniki").html(setp1+" > "+setp2+" "+nazwap1+" vs "+nazwap2+" win");

$("#wyniki").html(nazwap1+" vs "+nazwap2+" win");


$("#bank1").html(parseInt($("#bank1").html())+10);
$("#bank2").html(parseInt($("#bank2").html())-10);

}else {
if(setp1==setp2){

//alert(nazwap1+" vs "+nazwap2+" remis");
$("#wyniki").html(nazwap1+" vs "+nazwap2+" remis");
}else{
//alert(nazwap1+" vs "+nazwap2+" win");
//$("#wyniki").html(setp1+" rest "+setp2+" "+nazwap1+" vs "+nazwap2+" lose");
...
function dobij(){
	//alert($("#pula2").html());
	$.get("bank1.php", { kasa : parseInt($("#pula2").html()) },  function(data) {

});
	
		$.get("mozna1.php", { mozna : parseInt($("#pula2").html()) },  function(data) {
...
function koncz(){
		...
		$.get("end1.php", { koncz : "1" },  function(data) {
...
window.location.href = 'win1.php?q='+$('#pula2').html();


}else {
if(setp1==setp2){

window.location.href = 'remis1.php?q='+$('#pula2').html();
//$("#wyniki").html(nazwap1+" vs "+nazwap2+" remis");
}else{

//$("#wyniki").html(nazwap1+" vs "+nazwap2+" lose");
window.location.href = 'lose1.php';
}
}
...
$.get("bank1.php", { kasa : $('#stawka').val() },  function(data) {
...
$.get("mozna1.php", { mozna : $('#stawka').val() },  function(data) {
